...
# for tauri
sudo apt-get install -y libgtk-3-dev libwebkit2gtk-4.0-dev libappindicator3-dev librsvg2-dev patchelf wget unzip pkg-config libprotobuf-dev protobuf-compiler libssl-dev libgtk-3-dev libayatana-appindicator3-dev librsvg2-dev 
